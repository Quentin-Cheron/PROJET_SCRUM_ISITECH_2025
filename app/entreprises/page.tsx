...
import { ArrowLeft, Building2, Users, Target, FileText, CheckCircle, Phone, Mail } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F2E8DC]">
      ...
      <div className="bg-gradient-to-r from-[#0A1D35] to-[#163554] text-[#F2E8DC] py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 text-[#F2E8DC] hover:text-[#6CAED6] transition-colors mb-4"
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8">
          <p 
            ...
            style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
          >
            Investissez dans le bien-être et le développement de vos équipes avec nos solutions personnalisées. 
            Nous proposons des interventions sur mesure adaptées à vos besoins spécifiques et à votre culture d'entreprise.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Nous analysons votre situation et élaborons une proposition personnalisée
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-[#D0E7F5] to-[#F2E8DC] rounded-xl p-6">
              ...
              <p 
                ...
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Sessions de groupe pour la gestion du stress, le bien-être au travail et le développement personnel.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Gestion du stress et des émotions</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Sophrologie et relaxation</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Communication et cohésion d'équipe</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#D0E7F5] to-[#F2E8DC] rounded-xl p-6">
              ...
              <p 
                ...
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Séances personnalisées pour vos collaborateurs : coaching, développement personnel et équilibre de vie.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Coaching professionnel</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Connaissance de soi (MBTI, Ennéagramme)</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Hypnothérapie et sophrologie</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#D0E7F5] to-[#F2E8DC] rounded-xl p-6">
              ...
              <p 
                ...
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Modules de formation sur le bien-être, la gestion du stress et le développement des compétences relationnelles.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Gestion du stress et résilience</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Communication interpersonnelle</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Équilibre vie professionnelle / personnelle</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#D0E7F5] to-[#F2E8DC] rounded-xl p-6">
              ...
              <p 
                ...
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Solutions complètes adaptées à vos enjeux spécifiques : qualité de vie au travail, prévention des risques psycho-sociaux.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Programmes QVT (Qualité de Vie au Travail)</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Prévention des RPS</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[#0A1D35]">
                  <CheckCircle size={16} className="text-[#6CAED6] mt-0.5 flex-shrink-0" />
                  <span style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>Accompagnement au changement</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Amélioration du bien-être, de la productivité et de la cohésion d'équipe
              </p>
            </div>
          </div>
        </section>
