    ...
    setFormData((prev) => {
      ...
      if (field === "nombreSeances" || field === "prixUnitaire") {
        if (updated.nombreSeances && updated.prixUnitaire) {
          const total = parseFloat(updated.nombreSeances) * parseFloat(updated.prixUnitaire);
          if (!isNaN(total)) {
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Génération de contrat</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </header>
        <div className="flex flex-1 flex-col gap-4 p-4 md:p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h1 className="text-2xl font-bold">Génération de contrat de prestation</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-white rounded-lg border px-7 py-4">
              <h2 className="text-xl font-semibold mb-4">Informations du prestataire (SYNEGO)</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("prestataireAdresse", e.target.value)}
                    required
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("prestataireEmail", e.target.value)}
                    required
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("prestataireTelephone", e.target.value)}
                    required
                  />
                </div>
              </div>
            ...
            {/* Informations du bénéficiaire */}
            <div className="bg-white rounded-lg border px-7 py-4">
              <h2 className="text-xl font-semibold mb-4">Informations du bénéficiaire</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("beneficiaireAdresse", e.target.value)}
                    required
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("beneficiaireEmail", e.target.value)}
                    required
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("beneficiaireTelephone", e.target.value)}
                    required
                  />
                </div>
              </div>
            ...
            {/* Informations du contrat */}
            <div className="bg-white rounded-lg border px-7 py-4">
              <h2 className="text-xl font-semibold mb-4">Informations du contrat</h2>
            ...
            <div className="bg-white rounded-lg border px-7 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="dureeSeance">Durée d'une séance (en minutes)</Label>
                  <Input
                    id="dureeSeance"
                    type="number"
                    min="1"
                ...
                <div className="space-y-2">
                  ...
                  {formData.nombreSeances && formData.prixUnitaire && (
                    <p className="text-xs text-gray-500 mt-1">
                      Calcul automatique: {formData.nombreSeances} × {formData.prixUnitaire} € = {formData.prixTotal || (parseFloat(formData.nombreSeances) * parseFloat(formData.prixUnitaire)).toFixed(2)} €
                    </p>
                  )}
                </div>
                <div className="md:col-span-2 space-y-2">
                  <Label htmlFor="descriptionPrestation">Description détaillée de la prestation</Label>
                  <Textarea
                    id="descriptionPrestation"
                    value={formData.descriptionPrestation}
                    onChange={(e) => handleChange("descriptionPrestation", e.target.value)}
                    rows={4}
                    required
                  />
                </div>
            ...
            {/* Conditions particulières */}
            <div className="bg-white rounded-lg border px-7 py-4">
              <h2 className="text-xl font-semibold mb-4">Conditions particulières (optionnel)</h2>
              <div className="space-y-2">
            ...
            <div className="bg-white rounded-lg border px-7 py-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Le lien Qonto sera inclus dans le contrat pour permettre au bénéficiaire d'effectuer le paiement.
                </p>
              </div>
            </div>
