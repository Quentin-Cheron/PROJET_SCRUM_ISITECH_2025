    ...
    <div className="min-h-screen bg-[#F2E8DC]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section 
          ...
          className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 scroll-mt-20"
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 
                className="text-2xl md:text-3xl font-bold text-[#0A1D35]"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 700 }}
              >
                Équilibre émotionnel
              </h2>
              <p 
                className="text-sm md:text-base text-[#0A1D35] italic"
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
          ...
          <div className="space-y-6">
            <p 
              className="text-base md:text-lg text-[#0A1D35] leading-relaxed"
              style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
            >
            ...
            <div>
              <h3 
                className="text-xl md:text-2xl font-bold text-[#0A1D35] mb-4"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 700 }}
              >
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-[#D0E7F5] rounded-xl p-4">
                  <h4 
                    className="font-semibold text-[#0A1D35] mb-2"
            ...
            <div className="bg-[#6CAED6] rounded-xl p-6 text-center">
              ...
              <Link 
                href="/reservation"
                className="inline-flex items-center gap-2 bg-white hover:bg-[#F2E8DC] text-[#0A1D35] font-semibold px-6 py-3 rounded-md transition-all duration-300 hover:scale-105"
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Réserver une séance
                <ArrowRight size={18} />
        ...
        <section 
          id="connaissance-de-soi"
          className="bg-gradient-to-br from-[#D0E7F5] via-white to-[#F2E8DC] rounded-2xl shadow-2xl p-6 md:p-8 mb-8 border-2 border-[#6CAED6] scroll-mt-20"
        >
          <div className="flex items-center gap-4 mb-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#0A1D35] to-[#163554] rounded-xl p-6 text-center">
              ...
              <Link 
                href="/reservation"
                className="inline-flex items-center gap-2 bg-[#6CAED6] hover:bg-[#5a9bc4] text-[#0A1D35] font-semibold px-6 py-3 rounded-md transition-all duration-300 hover:scale-105"
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Réserver une séance
                <ArrowRight size={18} />
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#D9C9B4] rounded-xl p-6 text-center">
              ...
              <Link 
                href="/reservation"
                className="inline-flex items-center gap-2 bg-[#0A1D35] hover:bg-[#163554] text-white font-semibold px-6 py-3 rounded-md transition-all duration-300 hover:scale-105"
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                Réserver une séance
                <ArrowRight size={18} />
